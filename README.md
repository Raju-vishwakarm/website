...
<body>
    <header>
        <div class="logo">
            <img src="Fusion feast logo.png" alt="FUSION FEAST Logo">
    ...
    <main>
        ...
        <section class="features">
            <div class="feature">
                <h3>Today's menu</h3>
                <img src="food items.png" alt="Our New Menu">
            ...
            <div class="feature">
                <h3>Book a table</h3>
                <img src="Book a table.png" alt="Book a table">
            ...
            <div class="feature">
                ...
                <img src="Opening hours.png" class="hours" alt="Opening Hours">
        ...
        <footer>
            <div class="logo">
                <img src="Fusion feast logo.png" class="footer" alt="Fusion feast Logo">
            </div>
            ...
            <h3align="center" style="font-family:'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif; font-style: italic; ">
                Developed and designed by RAJU D</h3>
        </footer>
    </main>
</body>
</html>
...
<div class="logo">
    <top left>
    <img src="Fusion feast logo.png" width="50" height="50"alt="FUSION FEAST Logo">
</top left>
...
<body bgcolor="lavender">
    ...
    <div class="logo">
        <img src="Fusion feast logo.png" width="50" height="50" class="footer" alt="Fusion feast Logo">
    </div>
...
<body>
    ...
    <div class="menu-container">
        ...
        <div class="menu-items">
            <div class="menu-item">
                <img src="Baby corn salt pepper.png" alt="Baby corn salt pepper">
            ...
            <div class="menu-item">
                <img src="Veg momo.png" alt="Veg momos">
                <div class="menu-details">
                    <h3>Veg momos</h3>
                    <p class="price">₹100/-</p>
                </div>
            ...
            <div class="menu-item">
                <img src="Aloo tikki.png" alt="Aloo tikki">
                <div class="menu-details">
                    <h3>Aloo tikki</h3>
                    <p class="price">₹120/-</p>
                </div>
            ...
            <div class="menu-item">
                <img src="Prawn fry.png" alt="Prawn fry">
                <div class="menu-details">
                    <h3>Prawn fry</h3>
                    <p class="price">₹180/-</p>
                </div>
            ...
            <div class="menu-item">
                <img src="Tandoori chicken.png" alt="Tandoori chicken">
                <div class="menu-details">
            ...
            <div class="menu-item">
                <img src="South indian meals.png" alt="South indian meals">
                <div class="menu-details">
            ...
            <div class="menu-item">
                <img src="Avakai annam.png" alt="Avakai annam">
                <div class="menu-details">
                    <h3>Avakai annam</h3>
                    <p class="price">₹150/-</p>
                </div>
            ...
            <div class="menu-item">
                <img src="Avakai chicken biriyani.png" alt="Avakai chicken biriyani">
                <div class="menu-details">
...
<!DOCTYPE html>
 ...
 <body>
    <header>
        <top left>
        <div class="logo">
            <img src="Fusion feast logo.png" width="100" height="100" alt="FUSION FEAST Logo">
        ...
        <div class="container">
            ...
            <div class="team-section">
                <div class="team-member">
                    <img src="Hari nayak.png" alt="Hari nayak.jpg">
                    <h3>Hari nayak-Marketing director</h3>
                   
                </div>
                <div class="team-member">
                    <img src="Ranveer brar.png" alt="Ranveer brar.jpg">
                    <h3>Ranveer brar-Manager</h3>

                </div>
                <div class="team-member">
                    <img src="Saransh goila.png" alt="Saransh goila.jpg">
...
![alt text](<rest/restapp/static/Screenshot (101).png>)

![alt text](<rest/restapp/static/Screenshot (102).png>)

![alt text](<rest/restapp/static/Screenshot (103).png>)

![alt text](<rest/restapp/static/Screenshot (104).png>)
# RESULT:
